...
def test_select(sql_manager, rapid_run_dir, x_run_dir):
    ...
    xparse.add(sql_manager, x_run_dir)
    parse.add(sql_manager, rapid_run_dir, unaligned)
    selection = api.select(flowcell, project).group_by(Unaligned.lane).all()

    assert selection == [
        ('SIB914A11_sureselect11', 'HB07NADXX', '1', '38088672', 76358568, '3847',
         7712, '93.71', '36.27'),
        ('SIB914A11_sureselect11', 'HB07NADXX', '2', '38269896', 76358568, '3865',
         7712, '93.70', '36.27'),
        ('SIB914A12_sureselect12', 'HB07NADXX', '1', '48201748', 96393600, '4868',
         9735, '94.39', '36.49'),
        ('SIB914A12_sureselect12', 'HB07NADXX', '2', '48191852', 96393600, '4867',
         9735, '94.40', '36.49'),
        ('SIB914A15_sureselect15', 'HB07NADXX', '1', '57947620', 115945150, '5853',
         11711, '94.32', '36.46'),
        ('SIB914A15_sureselect15', 'HB07NADXX', '2', '57997530', 115945150, '5858',
         11711, '94.33', '36.46'),
        ('SIB914A2_sureselect2', 'HB07NADXX', '1', '32032000', 64048648, '3235',
         6469, '94.11', '36.40'),
        ('SIB914A2_sureselect2', 'HB07NADXX', '2', '32016648', 64048648, '3234',
         6469, '94.12', '36.40')
    ]
