    ...
    for sample in samples:
        ...
        for line in samplesheet.lines_per_column("sample_id", sample):
            ...
            summaries[lane][sample].append(
                get_sample_summary(et_stats_file, line["project"], barcode, lane)
            )

            summaries[lane][sample].append(
                get_barcode_summary(et_index_file, line["project"], barcode, lane)
            )
...
def parse(unaligned_dir):
    ...
    for lane in lanes:
        ...
        for line in samplesheet.lines_per_column("lane", lane):
            summaries[lane].append(
                get_barcode_summary(
                    et_index_file, line["project"], line.dualindex, lane
                )
            )
    ...
    sample_stats = (
        {}
    )  # generate a dict: raw sample name is key, value is a dict of stats
