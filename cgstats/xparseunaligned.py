...
def main(argv):
    ...
    pprint(
        xstats.parse_samples(
            "/mnt/hds/proj/bioinfo/DEMUX/161125_ST-E00269_0150_AH37GVALXX"
        )
    )
    pprint(
        xstats.parse_samples(
...
if __name__ == "__main__":
    ...
    cProfile.run(
        'xstats.parse("/mnt/hds/proj/bioinfo/DEMUX/161125_ST-E00269_0150_AH37GVALXX")',
        outfile,
    )
    ...
    cProfile.run(
        'xstats.parse_samples("/mnt/hds/proj/bioinfo/DEMUX/161125_ST-E00269_0150_AH37GVALXX")',
        outfile,
    )
    p = pstats.Stats(outfile)
    p.sort_stats("cumtime").print_stats(10)
